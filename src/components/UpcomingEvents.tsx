  ...
  const events = [
    {
      title: "",
      date: "",
      image: "/event-images/event-23.jpg",
      footnote: "Registrations are open!!", // 👈 edit this anytime
    },
  ];

  const formLink =
    "https://docs.google.com/forms/d/e/1FAIpQLSfZF9kLWoSqvRqc8H7UE3CxWyLWRF6wfJ6qjRo_nI72A4-NsQ/viewform?usp=publish-editor";
